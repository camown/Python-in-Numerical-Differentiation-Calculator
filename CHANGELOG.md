...
## v1.0.0 - Week 13
Focus: Final Documentation Output
- Finalized documentation (README) including setup, usage, features, and limitations.
- Generated a comprehensive 1-2 page user guide with screenshots.
- Embedded final versioning (`v1.0.0`) into the Tkinter UI and About section.
- Generated and attached 3 sample exported reports to the final submission.

## v0.9.0 - Week 12
Focus: Testing & QA Output
- Executed rigorous QA with a finalized testing checklist containing a minimum of 10 tests.
- Compiled a bug list and implemented at least 3 distinct fixes.
- Performed regression testing by re-running earlier tests to guarantee core functionality remained unbroken.

## v0.8.0 - Week 11
Focus: UI/Formatting Output
- Polished Tkinter UI layout for improved readability.
- Aligned labels, input fields, and buttons using consistent grid spacing.
- Standardized the solution trail formatting, implementing clear block headings and proper text indentation.

## v0.7.0 - Week 10
Focus: Verification & Export Output
- Implemented file export functionality via `filedialog`.
- Allowed users to export the solution trail as a `.txt` report file for auditing purposes.
- Ensured exports properly capture GIVEN, METHOD, STEPS, FINAL, VERIFICATION, and SUMMARY blocks.
